...
%changelog
* Mon Sep 21 2026 Codex Automation <noreply@users.noreply.github.com> - 1.18.31-1
- Track upstream stable release via npm dist-tag (opencode-ai); anomalyco/opencode 2.x tags ship no release binaries
